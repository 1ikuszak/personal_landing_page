...
const LastChanceCard = () => {
  return (
    <div className="flex justify-center p-4 border border-black rounded-lg lg:p-12 itmes-center">
      <div className="hidden lg:flex w-[3px] my-2 bg-black rounded-full"></div>
